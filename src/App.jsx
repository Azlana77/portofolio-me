...
function AssetImage({
  ...
  if (!src || failed) {
    return (
      <div
        className={`flex items-center justify-center bg-[#0b2545] text-cyan-100 ${fallbackClassName || className}`}
      >
...
function ButtonLink({
  ...
  const styles = {
    primary:
      "bg-[#071725] text-white shadow-lg shadow-slate-900/15 hover:bg-[#0b2545]",
    light:
      "border border-slate-200 bg-white text-[#071725] hover:border-cyan-300 hover:text-cyan-800",
...
function ProjectCard({ project }) {
  ...
  return (
    <article
      className={`overflow-hidden rounded-lg border bg-white shadow-sm transition hover:-translate-y-1 hover:shadow-xl ${project.featured ? "border-cyan-300 shadow-cyan-900/10" : "border-slate-200"}`}
    >
      <div className="relative h-52 bg-[#0b2545]">
        {project.image ? (
          project.tallImage ? (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              aria-label={`Buka gambar ${project.title}`}
            >
              {visual}
            </a>
          ) : (
        ...
        <div className="absolute left-4 top-4 flex flex-wrap gap-2">
          <span className="rounded-full bg-white px-3 py-1 text-xs font-bold text-[#071725]">
            {project.category}
          </span>
          {project.badge ? (
            <span className="rounded-full bg-emerald-400 px-3 py-1 text-xs font-bold text-[#071725]">
              {project.badge}
            </span>
          ) : null}
        </div>
    ...
    <div className="min-h-screen bg-[#f6f8fb]">
      ...
      <header className="sticky top-0 z-50 border-b border-white/70 bg-white/85 backdrop-blur">
        <nav className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
          <a
            href="#main"
            className="flex items-center gap-3 font-bold text-[#071725]"
          >
            <span className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#071725] text-sm text-white">
              AM
            </span>
      ...
      <main id="main">
        <section className="bg-[#071725] text-white">
          <div className="mx-auto grid max-w-6xl items-center gap-10 px-4 py-14 sm:px-6 md:grid-cols-[1.1fr_0.9fr] md:py-20 lg:px-8">
            <div>
              ...
              <p className="mt-4 text-xl font-bold text-cyan-100 md:text-2xl">
                {profile.headline}
              </p>
              <p className="mt-5 max-w-2xl text-base leading-7 text-slate-200">
                Portofolio sederhana untuk peluang magang di bidang IoT, sistem
                embedded, database, dan pengembangan sistem yang menghubungkan
        ...
        <section id="about" className="px-4 py-16 sm:px-6 lg:px-8">
          <div className="mx-auto grid max-w-6xl gap-8 md:grid-cols-[0.8fr_1.2fr]">
            <div>
              ...
              <h2 className="text-3xl font-bold text-[#071725] md:text-4xl">
                Latar elektronika, bergerak ke sistem digital.
              </h2>
            </div>
        ...
        <section id="skills" className="bg-white px-4 py-16 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-6xl">
            <SectionHeading
              ...
              title="Kemampuan yang relevan untuk proyek teknis."
            />
                ...
                return (
                  ...
                  >
                    <div className="mb-4 flex items-center gap-3">
                      ...
                      <h3 className="font-bold text-[#071725]">
                        {group.title}
                      </h3>
                    </div>
                    <div className="flex flex-wrap gap-2">
                      {group.items.map((skill) => (
                        <span
                          key={skill}
                          className="rounded-full bg-white px-3 py-1.5 text-sm font-bold text-slate-700 shadow-sm"
                        >
                          {skill}
                        </span>
                      ))}
        ...
        <section id="projects" className="px-4 py-16 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-6xl">
            <SectionHeading
              eyebrow="Proyek"
              title="Proyek IoT, database, dan web development."
            />
        ...
        <section
          id="experience"
          className="bg-[#071725] px-4 py-16 text-white sm:px-6 lg:px-8"
        >
          <div className="mx-auto max-w-6xl">
            <div className="mx-auto mb-8 max-w-3xl text-center md:mb-10">
              <p className="mb-3 text-sm font-bold uppercase text-cyan-200">
                Pengalaman
              </p>
              <h2 className="text-3xl font-bold md:text-4xl">
                Pengalaman kerja yang membentuk ketelitian dan tanggung jawab.
              </h2>
            </div>
              ...
              {experiences.map((item) => (
                ...
                >
                  <div className="mb-4 flex items-start justify-between gap-4">
                    <Briefcase
                      aria-hidden="true"
                      className="mt-1 h-5 w-5 text-cyan-200"
                    />
                    <span className="rounded-full bg-white px-3 py-1 text-xs font-bold text-[#071725]">
                      {item.duration}
                    </span>
        ...
        <section id="education" className="px-4 py-16 sm:px-6 lg:px-8">
          <div className="mx-auto grid max-w-6xl gap-8 md:grid-cols-[0.9fr_1.1fr]">
            <div>
              ...
              <h2 className="text-3xl font-bold text-[#071725] md:text-4xl">
                Dasar akademik dan elektronika praktis.
              </h2>
            </div>
        ...
        >
          <div className="mx-auto max-w-6xl">
            <SectionHeading
              eyebrow="Sertifikasi"
              title="Pelatihan yang mendukung minat teknis."
            />
          ...
          <div className="mx-auto max-w-6xl rounded-lg bg-[#0b2545] p-6 text-white shadow-xl shadow-slate-900/15 md:p-10">
            <div className="grid gap-8 md:grid-cols-[1fr_1fr] md:items-center">
              <div>
                ...
                <h2 className="text-3xl font-bold md:text-4xl">
                  Terbuka untuk peluang magang dan kolaborasi.
                </h2>
                <p className="mt-4 leading-7 text-slate-200">
                  Silakan hubungi melalui email, WhatsApp, atau lihat profil
                  GitHub untuk mengenal proyek dan minat teknis saya lebih
                  lanjut.
                </p>
              </div>
              <div className="grid gap-3">
                ...
                <ButtonLink
                  href="https://wa.me/6289509786701"
                  variant="ghost"
                  icon={Phone}
                >
      ...
      <footer className="border-t border-slate-200 bg-white px-4 py-8 sm:px-6 lg:px-8">
        <div className="mx-auto flex max-w-6xl flex-col gap-3 text-sm text-slate-500 md:flex-row md:items-center md:justify-between">
          ...
          <a
            href="#main"
            className="inline-flex items-center gap-2 font-bold text-[#071725] hover:text-cyan-700"
          >
            Kembali ke atas
